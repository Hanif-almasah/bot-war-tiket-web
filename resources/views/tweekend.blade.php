            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-dark text-white text-center">
                        <h4 class="mb-0">Bot Ticket Remote Control</h4>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        <form action="/start-war" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="url_loket" id="url_loket" class="form-control" value="https://www.theweekndinjakarta.com/" required>
                            </div>

                            <div class="mb-3">
                                <label for="selector_tombol" class="form-label fw-bold">Selector / Class Tombol Beli:</label>
                                <input type="text" name="selector_tombol" id="selector_tombol" class="form-control" placeholder="Contoh: .lp-button atau #buy-btn" value=".btn-orange" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="targetIndex" id="targetIndex" class="form-control" placeholder="Masukkan nomor tombol (0-6)" min="0" max="6" value="0" required>
                            </div>
