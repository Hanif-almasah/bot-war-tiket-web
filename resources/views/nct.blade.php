                    ...
                    <div class="card-body">
                        ...
                        <form action="/start-war" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="url_loket" id="url_loket" class="form-control" placeholder="https://widget.loket.com/..." value="https://dyandraglobalstore-04.com/#layout" required>
                            </div>
